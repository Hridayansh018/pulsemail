                    ...
                    <tr key={campaign.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => {
                              // Show full email details in a modal or alert
                              alert(`Campaign: ${campaign.campaign_name}\n\nSubject: ${campaign.subject}\n\nMessage: ${campaign.message}\n\nRecipients: ${campaign.email_list.join(', ')}`);
                            }}
        ...
        {campaigns.length > 0 && (
          <div className="mt-6 rounded-lg border border-white/10 bg-white/5 p-4 backdrop-blur-md">
            <div className="flex items-center justify-between text-sm text-white/70">
              ...
              <span>
                Total emails sent: {campaigns.reduce((sum, c) => sum + c.email_list.length, 0)}
              </span>
            </div>
          </div>
        )}
